...
class BMFLocationOptionsMethodId {
  ...
  static const kDisableLocInForeground =
      BMFLocationConstants.kLocationChannelName + '/setDisableLocInForeground';

  static const kEnableLocInForeground =
      BMFLocationConstants.kLocationChannelName + '/setEnableLocInForeground';
}
