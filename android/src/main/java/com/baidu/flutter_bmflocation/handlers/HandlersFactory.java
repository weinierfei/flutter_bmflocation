...
public class HandlersFactory {
    ...
    private HandlersFactory() {
        ...
        methodHandlerMap.put(Constants.MethodID.LOCATION_STARTHEADING, HeadingResultHandler.getInstance());
        methodHandlerMap.put(Constants.MethodID.LOCATION_STOPHEADING, HeadingResultHandler.getInstance());
        methodHandlerMap.put(Constants.MethodID.LOCATION_STOP_FOREGROUND, new LocationResultHandler());
        methodHandlerMap.put(Constants.MethodID.LOCATION_START_FOREGROUND, new LocationResultHandler());
    }
    ...
    public void dispatchMethodHandler(Context context, MethodCall call, MethodChannel.Result result) {
        ...
        switch (method) {
            ...
            case Constants.MethodID.LOCATION_STOPHEADING:
                ...
                break;
            case Constants.MethodID.LOCATION_STOP_FOREGROUND:
                methodChannelHandler =
                        methodHandlerMap.get(Constants.MethodID.LOCATION_STOP_FOREGROUND);
                break;
            case Constants.MethodID.LOCATION_START_FOREGROUND:
                methodChannelHandler =
                        methodHandlerMap.get(Constants.MethodID.LOCATION_START_FOREGROUND);
                break;
            default:
                break;
        }
