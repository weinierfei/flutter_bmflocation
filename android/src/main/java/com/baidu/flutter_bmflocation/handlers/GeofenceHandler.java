...
public class GeofenceHandler extends MethodChannelHandler {
    ...
    public GeofenceHandler() {
        mMethodChannel = MethodChannelManager.getInstance().getGeofenceChannel();
    }
    ...
    public void handleMethodGeofenceCallResult(
        ...
        if (null == filter) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                mContext.registerReceiver(mGeoFenceReceiver, filter, Context.RECEIVER_NOT_EXPORTED);
            } else {
    ...
    void addGeofence(GeoFenceClient mGeofenceClient, Map arguments) {
        ...
        if (arguments != null) {
            ...
            } else if (arguments.containsKey("coordinateList") && arguments.get("coordinateList") != null) {
