...
public class Constants {
    ...
    public static class MethodID {
        ...
        public static final String LOCATION_STOP_FOREGROUND =
                MethodChannelName.LOCATION_CHANNEL + "/setDisableLocInForeground";

        public static final String LOCATION_START_FOREGROUND =
                MethodChannelName.LOCATION_CHANNEL + "/setEnableLocInForeground";
    }
}
